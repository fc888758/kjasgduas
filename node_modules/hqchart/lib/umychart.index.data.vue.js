...
function CustomIndexScript() {
    this.DataMap = new _map2.default(); //key=指标id, value=data {ID:, Name：指标名字, Description：指标描述信息 Args:参数 ......}
...
JSIndexScript.prototype.ShareHolder = function () {
    var data = {
        ...
        Condition: { Period: [CONDITION_PERIOD.KLINE_DAY_ID, CONDITION_PERIOD.KLINE_MONTH_ID, CONDITION_PERIOD.KLINE_WEEK_ID, CONDITION_PERIOD.KLINE_YEAR_ID] },
        Args: [],
        Script: //脚本
        "人数:FINANCE(100);"
    };
