    ...
    <view>
        <view class="container">
            ...
            <movable-area class="movable-customer-service-area">
                <movable-view class="float-customer-service" direction="all" :x="initialX" :y="initialY"
                    @change="onCustomerServiceMove" @click="contactCustomerService">
                    <image src="/static/icon/customer-service-icon.png" mode="aspectFit"></image>
                </movable-view>
            </movable-area>

            <!-- 底部导航栏 -->
            <up-tabbar :value="currentIndexTab" @change="handleTabChange" :fixed="true" :placeholder="true"
                activeColor="#333">
