		...
		<view class="user-info">
			...
			<view class="user-profile" v-if="userInfo">
				...
				<view class="user-details">
					...
					<text class="username">{{ userInfo.is_real_name == 2 ? maskName(userInfo.username) : '未实名' }}</text>
		...
		<view class="menu-list">
			...
			<view class="menu-item" @click="transactionHistory(6)">
				<view class="menu-left">
					...
					<text class="menu-text">实名认证</text> <text v-if="userInfo && realNameText" style="color: red">({{
						realNameText }})</text>
				</view>
				<image class="arrow-icon" src="../../static/icon/user-right-icon.png" mode="aspectFit"></image>
			</view>
