                ...
                <view class="balance-info">
                    <view class="balance-title">
                        ...
                        <image class="eye-icon"
                            ...
                            mode="aspectFit" @click="toggleBalanceVisibility"></image>
                    </view>
        ...
        <view class="trade-container">
            ...
            <view class="function-nav">
                <view v-for="(item, index) in navItems" :key="index" class="nav-item"
                    :class="[currentNav[0] == index ? 'active' : '']" @click="handleNavClick(index)">
                    <text>{{ item }}</text>
                </view>
            </view>

            <up-tabs :list="list[0]" :current="currentNav[1]" :activeStyle="{
                color: '#deb36f',
                fontWeight: 'bold',
                transform: 'scale(1.05)',
            }" :scrollable="false" lineColor="#deb36f" keyName="name" @click="setPurchaseStatus"
                v-if="currentNav[0] == 0"></up-tabs>
            <up-tabs :list="list[1]" :current="currentNav[1]" :activeStyle="{
                color: '#deb36f',
                fontWeight: 'bold',
                transform: 'scale(1.05)',
            }" :scrollable="false" lineColor="#deb36f" keyName="name" @click="setPurchaseStatus"
                v-if="currentNav[0] == 1"></up-tabs>
            <up-tabs :list="list[2]" :current="currentNav[1]" :activeStyle="{
                color: '#deb36f',
                fontWeight: 'bold',
                transform: 'scale(1.05)',
            }" :scrollable="false" lineColor="#deb36f" keyName="name" @click="setPurchaseStatus"
                v-if="currentNav[0] == 2"></up-tabs>
            <up-tabs :list="list[3]" :current="currentNav[1]" :activeStyle="{
                color: '#deb36f',
                fontWeight: 'bold',
                transform: 'scale(1.05)',
            }" lineColor="#deb36f" keyName="name" @click="setPurchaseStatus" v-if="currentNav[0] == 3"></up-tabs>
                ...
                <view class="purchase-records">
                    <view class="record-item" v-for="(item, index) in purchaseRecords" :key="index">
                        ...
                        <view class="record-details">
                            ...
                            <view class="detail-row" v-if="item.phase_money">
                                ...
                                <text class="detail-value" :class="item.phase_money && item.phase_money.toString().includes('-')
                                    ? 'status-paid'
                                    : 'status-all'
                            ...
                            <view class="detail-row" v-if="item.phase_pre">
                                ...
                                <text class="detail-value" :class="item.phase_pre && item.phase_pre.toString().includes('-')
                                    ? 'status-paid'
                                    : 'status-all'
                                    ">{{ `${item.phase_pre}%` }}</text>
                            </view>
                        ...
                        <view class="record-action">
                            ...
                            <view class="action-btn sell-btn" @click="sellStock(item)" v-if="
                            ...
                            <view class="action-btn sell-btn" @click="ipoSubscription(item)"
                    ...
                    <view class="pagination-container" v-if="purchaseRecords.length > 0">
                        <u-pagination :current-page="currentPage" :page-size="pageSize" :total="total"
                            layout="prev, pager, next" @current-change="loadPurchaseRecords" />
                    </view>
                </view>
