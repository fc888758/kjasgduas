        ...
        <view class="stock-info">
            <view class="stock-price-section">
                <view class="price-main">
                    <text class="current-price" :style="{ color: stockDetail.chg < 0 ? '#00b386' : '#fb4e50' }">{{ stockDetail.current }}</text>
                    <view class="price-change">
                        <text
                            class="change-value"
                            :style="{
                                color: stockDetail.chg < 0 ? '#00b386' : '#fb4e50',
                            }"
            ...
            <view class="stock-details-grid">
                ...
                <view class="detail-row">
                    <view class="detail-item">
                        ...
                        <text class="detail-value" :style="{ color: compareWithPreClose(stockDetail.low) }"> {{ stockDetail.low }}</text>
                    </view>
                    <view class="detail-item">
...
<script>
//import Hqchart from './components/hqchart/index1.vue';
...
export default {
    ...
    computed: {
        // 格式化成交量./components/hqchart/index1.vue
        formattedVolume() {
