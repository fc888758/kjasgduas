<template>
    <view class="newStockDetail">
        ...
        <view class="stock-info">
            ...
            <view class="info-row">
                <text class="info-label">发行数量(万股)</text>
                <text class="info-value">{{ formatToWan(stockInfo.today[index].issue_number) }}</text>
            </view>
            <view class="info-row">
                <text class="info-label">剩余发行数量(万股)</text>
                <text class="info-value">{{ formatToWan(stockInfo.today[index].residue_number) }}</text>
            </view>
        </view>
